...
// Using https://bcherny.github.io/json-schema-to-typescript-browser/
// With the input being:
// https://raw.githubusercontent.com/microsoft/debug-adapter-protocol/gh-pages/debugAdapterProtocol.json
//
// Manual changes:
// - Added Command, EventType and MessageType enums.
// - Added `declare` to all interfaces to allow JSCompiler renaming.

// tslint:disable:jsdoc-format
// tslint:disable:no-any
// tslint:disable:comments-documentation
...
export declare interface ProtocolMessage {
  /**
...
export declare interface Request extends ProtocolMessage {
  // type: 'request';
...
export declare interface Event extends ProtocolMessage {
  // type: 'event';
  /** Type of event. */
  event: EventType;
...
export declare interface Response extends ProtocolMessage {
  // type: 'response';
  ...
  /**
    ...
    result of the request. If the value is false, the attribute 'message'
    contains the error in short form and the 'body' may contain additional
    information (see 'ErrorResponse.body.error').
  */
  success: boolean;
  ...
  /**
    ...
    UI. Some predefined values exist. Values: 'cancelled': request was
    cancelled. etc.
  */
  message?: string;
  /**
 ...
 */
export declare interface ErrorResponse extends Response {
  body: {
...
/**
  ...
  true) or an error response ('success' attribute false and the 'message' set to
  'cancelled'). Returning partial results from a cancelled request is possible
  but please note that a frontend client has no generic way for detecting that a
  response is partial or not.
*/
export declare interface CancelRequest extends Request {
  // command: 'cancel';
  arguments?: CancelArguments;
}

/** Arguments for 'cancel' request. */
export declare interface CancelArguments {
 ...
 * field is required.
 */
export declare interface CancelResponse extends Response {}

/**
  Event message for 'initialized' event type.
  This event indicates that the debug adapter is ready to accept configuration
  requests (e.g. SetBreakpointsRequest, SetExceptionBreakpointsRequest). A debug
  adapter is expected to send this event when it is ready to accept
  ...
  configuration.
*/
export declare interface InitializedEvent extends Event {
  // event: 'initialized';
}
...
*/
export declare interface StoppedEvent extends Event {
  // event: 'stopped';
  body: {
    /**
...
/**
  ...
  Please note: a debug adapter is not expected to send this event in response to
  a request that implies that execution continues, e.g. 'launch' or 'continue'.
  It is only necessary to send a 'continued' event if there was no previous
  request that implied this.
*/
export declare interface ContinuedEvent extends Event {
  // event: 'continued';
  body: {
...
*/
export declare interface ExitedEvent extends Event {
  // event: 'exited';
  body: {
...
*/
export declare interface TerminatedEvent extends Event {
  // event: 'terminated';
  body?: {
    /**
...
*/
export declare interface ThreadEvent extends Event {
  // event: 'thread';
  body: {
    /**
      The reason for the event.
...
*/
export declare interface OutputEvent extends Event {
  // event: 'output';
  body: {
    /**
    ...
    */
    ...
    /**
      ...
      messages. 'start': Start a new group in expanded mode. Subsequent output
      events are members of the group and should be shown indented. The 'output'
      ...
      group and is not indented. 'end': End the current group and decreases the
      indentation of subsequent output events. A non empty 'output' attribute is
      shown as the unindented end of the group.
    */
...
*/
export declare interface BreakpointEvent extends Event {
  // event: 'breakpoint';
  body: {
    /**
      The reason for the event.
...
*/
export declare interface ModuleEvent extends Event {
  // event: 'module';
  body: {
    /** The reason for the event. */
...
*/
export declare interface LoadedSourceEvent extends Event {
  // event: 'loadedSource';
  body: {
    /** The reason for the event. */
    reason: 'new'|'changed'|'removed';
...
*/
export declare interface ProcessEvent extends Event {
  // event: 'process';
  body: {
    /**
    ...
    /**
      ...
      'attachForSuspendedLaunch': A project launcher component has launched
      a new process in a suspended state and then asked the debugger to
      attach.
    */
...
*/
export declare interface CapabilitiesEvent extends Event {
  // event: 'capabilities';
  body: {
...
*/
export declare interface RunInTerminalRequest extends Request {
  // command: 'runInTerminal';
  arguments: RunInTerminalRequestArguments;
}

/** Arguments for 'runInTerminal' request. */
export declare interface RunInTerminalRequestArguments {
...
export declare interface RunInTerminalResponse extends Response {
  body: {
    /**
...
/**
  ...
  has responded with an 'initialize' response. The 'initialize' request may only
  be sent once.
*/
export declare interface InitializeRequest extends Request {
  // command: 'initialize';
  arguments: InitializeRequestArguments;
}

/** Arguments for 'initialize' request. */
export declare interface InitializeRequestArguments {
...
export declare interface InitializeResponse extends Response {
...
/**
  ...
  event).
*/
export declare interface ConfigurationDoneRequest extends Request {
  // command: 'configurationDone';
  arguments?: ConfigurationDoneArguments;
}

/** Arguments for 'configurationDone' request. */
export declare interface ConfigurationDoneArguments {}

/**
 * Response to 'configurationDone' request. This is just an acknowledgement, so
 * no body field is required.
 */
export declare interface ConfigurationDoneResponse extends Response {}
...
/**
  ...
  debugger/runtime specific, the arguments for this request are not part of this
  specification.
*/
export declare interface LaunchRequest extends Request {
  // command: 'launch';
 ...
 * specific.
 */
export declare interface LaunchRequestArguments {
  /**
 ...
 * field is required.
 */
export declare interface LaunchResponse extends Response {}

/**
  Attach request; value of command field is 'attach'.
  The attach request is sent from the client to the debug adapter to attach to a
  debuggee that is already running. Since attaching is debugger/runtime
  specific, the arguments for this request are not part of this specification.
*/
export declare interface AttachRequest extends Request {
  // command: 'attach';
 ...
 * specific.
 */
export declare interface AttachRequestArguments {
  /**
    Optional data from the previous, restarted session.
    The data is sent as the 'restart' attribute of the 'terminated' event.
    The client should leave the data intact.
 ...
 * field is required.
 */
export declare interface AttachResponse extends Response {}
...
*/
export declare interface RestartRequest extends Request {
  // command: 'restart';
  arguments?: RestartArguments;
}

/** Arguments for 'restart' request. */
export declare interface RestartArguments {}

/**
 * Response to 'restart' request. This is just an acknowledgement, so no body
 * field is required.
 */
export declare interface RestartResponse extends Response {}

/**
  Disconnect request; value of command field is 'disconnect'.
  The 'disconnect' request is sent from the client to the debug adapter in order
  to stop debugging. It asks the debug adapter to disconnect from the debuggee
  and to terminate the debug adapter. If the debuggee has been started with the
  'launch' request, the 'disconnect' request terminates the debuggee. If the
  'attach' request was used to connect to the debuggee, 'disconnect' does not
  terminate the debuggee. This behavior can be controlled with the
  'terminateDebuggee' argument (if supported by the debug adapter).
*/
export declare interface DisconnectRequest extends Request {
  // command: 'disconnect';
  arguments?: DisconnectArguments;
}

/** Arguments for 'disconnect' request. */
export declare interface DisconnectArguments {
  /**
 ...
 */
export declare interface DisconnectResponse extends Response {}
...
*/
export declare interface TerminateRequest extends Request {
  // command: 'terminate';
  arguments?: TerminateArguments;
}

/** Arguments for 'terminate' request. */
export declare interface TerminateArguments {
  /**
 ...
 * field is required.
 */
export declare interface TerminateResponse extends Response {}

/**
  BreakpointLocations request; value of command field is
  'breakpointLocations'. The 'breakpointLocations' request returns all possible
  locations for source breakpoints in a given range.
*/
export declare interface BreakpointLocationsRequest extends Request {
  // command: 'breakpointLocations';
  arguments?: BreakpointLocationsArguments;
}

/** Arguments for 'breakpointLocations' request. */
export declare interface BreakpointLocationsArguments {
  /**
...
*/
export declare interface BreakpointLocationsResponse extends Response {
  body: {
...
*/
export declare interface SetBreakpointsRequest extends Request {
  // command: 'setBreakpoints';
  arguments: SetBreakpointsArguments;
}

/** Arguments for 'setBreakpoints' request. */
export declare interface SetBreakpointsArguments {
  /**
   * The source location of the breakpoints; either 'source.path' or
   * 'source.reference' must be specified.
   */
...
*/
export declare interface SetBreakpointsResponse extends Response {
  body: {
    /**
       Information about the breakpoints. The array elements are in the same
       order as the elements of the 'breakpoints' (or the deprecated 'lines')
...
/**
  ...
  'setFunctionBreakpoints'. Replaces all existing function breakpoints with new
  function breakpoints. To clear all function breakpoints, specify an empty
  array. When a function breakpoint is hit, a 'stopped' event (with reason
  'function breakpoint') is generated.
*/
export declare interface SetFunctionBreakpointsRequest extends Request {
  // command: 'setFunctionBreakpoints';
  arguments: SetFunctionBreakpointsArguments;
}

/** Arguments for 'setFunctionBreakpoints' request. */
export declare interface SetFunctionBreakpointsArguments {
...
/**
  ...
  Returned is information about each breakpoint created by this request.
*/
export declare interface SetFunctionBreakpointsResponse extends Response {
  body: {
    /**
...
/**
  ...
  thrown exceptions. If an exception is configured to break, a 'stopped' event
  is fired (with reason 'exception').
*/
export declare interface SetExceptionBreakpointsRequest extends Request {
  // command: 'setExceptionBreakpoints';
  arguments: SetExceptionBreakpointsArguments;
}

/** Arguments for 'setExceptionBreakpoints' request. */
export declare interface SetExceptionBreakpointsArguments {
  /**
 ...
 */
export declare interface SetExceptionBreakpointsResponse extends Response {}
...
*/
export declare interface DataBreakpointInfoRequest extends Request {
  // command: 'dataBreakpointInfo';
  arguments: DataBreakpointInfoArguments;
}

/** Arguments for 'dataBreakpointInfo' request. */
export declare interface DataBreakpointInfoArguments {
  /**
   ...
   * for. If variableReference isn’t provided, this can be an expression.
   */
  name: string;
}

/** Response to 'dataBreakpointInfo' request. */
export declare interface DataBreakpointInfoResponse extends Response {
  body: {
    /**
...
/**
  ...
  breakpoint') is generated.
*/
export declare interface SetDataBreakpointsRequest extends Request {
  // command: 'setDataBreakpoints';
  arguments: SetDataBreakpointsArguments;
}

/** Arguments for 'setDataBreakpoints' request. */
export declare interface SetDataBreakpointsArguments {
  /**
...
/**
  ...
  Returned is information about each breakpoint created by this request.
*/
export declare interface SetDataBreakpointsResponse extends Response {
  body: {
    /**
       Information about the data breakpoints. The array elements
       correspond to the elements of the input argument 'breakpoints' array.
     */
    breakpoints: Breakpoint[];
  };
}
...
*/
export declare interface ContinueRequest extends Request {
  // command: 'continue';
  arguments: ContinueArguments;
}

/** Arguments for 'continue' request. */
export declare interface ContinueArguments {
  /**
...
export declare interface ContinueResponse extends Response {
  body: {
    /**
...
*/
export declare interface NextRequest extends Request {
  // command: 'next';
  arguments: NextArguments;
}

/** Arguments for 'next' request. */
export declare interface NextArguments {
 ...
 * field is required.
 */
export declare interface NextResponse extends Response {}
...
*/
export declare interface StepInRequest extends Request {
  // command: 'stepIn';
  arguments: StepInArguments;
}

/** Arguments for 'stepIn' request. */
export declare interface StepInArguments {
 ...
 * field is required.
 */
export declare interface StepInResponse extends Response {}
...
/**
  ...
  reason 'step') after the step has completed.
*/
export declare interface StepOutRequest extends Request {
  // command: 'stepOut';
  arguments: StepOutArguments;
}

/** Arguments for 'stepOut' request. */
export declare interface StepOutArguments {
 ...
 * field is required.
 */
export declare interface StepOutResponse extends Response {}
...
*/
export declare interface StepBackRequest extends Request {
  // command: 'stepBack';
  arguments: StepBackArguments;
}

/** Arguments for 'stepBack' request. */
export declare interface StepBackArguments {
 ...
 * field is required.
 */
export declare interface StepBackResponse extends Response {}

/**
  ReverseContinue request; value of command field is 'reverseContinue'.
  The request starts the debuggee to run backward. Clients should only call this
  request if the capability 'supportsStepBack' is true.
*/
export declare interface ReverseContinueRequest extends Request {
  // command: 'reverseContinue';
  arguments: ReverseContinueArguments;
}

/** Arguments for 'reverseContinue' request. */
export declare interface ReverseContinueArguments {
 ...
 * no body field is required.
 */
export declare interface ReverseContinueResponse extends Response {}
...
*/
export declare interface RestartFrameRequest extends Request {
  // command: 'restartFrame';
  arguments: RestartFrameArguments;
}

/** Arguments for 'restartFrame' request. */
export declare interface RestartFrameArguments {
 ...
 * body field is required.
 */
export declare interface RestartFrameResponse extends Response {}
...
*/
export declare interface GotoRequest extends Request {
  // command: 'goto';
  arguments: GotoArguments;
}

/** Arguments for 'goto' request. */
export declare interface GotoArguments {
 ...
 * field is required.
 */
export declare interface GotoResponse extends Response {}
...
*/
export declare interface PauseRequest extends Request {
  // command: 'pause';
  arguments: PauseArguments;
}

/** Arguments for 'pause' request. */
export declare interface PauseArguments {
 ...
 * field is required.
 */
export declare interface PauseResponse extends Response {}

/**
  StackTrace request; value of command field is 'stackTrace'.
  The request returns a stacktrace from the current execution state.
*/
export declare interface StackTraceRequest extends Request {
  // command: 'stackTrace';
  arguments: StackTraceArguments;
}

/** Arguments for 'stackTrace' request. */
export declare interface StackTraceArguments {
...
export declare interface StackTraceResponse extends Response {
  body: {
    /**
...
*/
export declare interface ScopesRequest extends Request {
  // command: 'scopes';
  arguments: ScopesArguments;
}

/** Arguments for 'scopes' request. */
export declare interface ScopesArguments {
  /** Retrieve the scopes for this stackframe. */
  frameId: number;
}

/** Response to 'scopes' request. */
export declare interface ScopesResponse extends Response {
  body: {
    /**
...
/**
  ...
  or indexed children.
*/
export declare interface VariablesRequest extends Request {
  // command: 'variables';
  arguments: VariablesArguments;
}

/** Arguments for 'variables' request. */
export declare interface VariablesArguments {
...
export declare interface VariablesResponse extends Response {
  body: {
...
*/
export declare interface SetVariableRequest extends Request {
  // command: 'setVariable';
  arguments: SetVariableArguments;
}

/** Arguments for 'setVariable' request. */
export declare interface SetVariableArguments {
...
export declare interface SetVariableResponse extends Response {
  body: {
...
*/
export declare interface SourceRequest extends Request {
  // command: 'source';
  arguments: SourceArguments;
}

/** Arguments for 'source' request. */
export declare interface SourceArguments {
  /**
...
export declare interface SourceResponse extends Response {
  body: {
...
*/
export declare interface ThreadsRequest extends Request {
  // command: 'threads';
}

/** Response to 'threads' request. */
export declare interface ThreadsResponse extends Response {
  body: {
    /** All threads. */
    threads: Thread[];
  };
...
*/
export declare interface TerminateThreadsRequest extends Request {
  // command: 'terminateThreads';
  arguments: TerminateThreadsArguments;
}

/** Arguments for 'terminateThreads' request. */
export declare interface TerminateThreadsArguments {
 ...
 * no body field is required.
 */
export declare interface TerminateThreadsResponse extends Response {}
...
*/
export declare interface ModulesRequest extends Request {
  // command: 'modules';
  arguments: ModulesArguments;
}

/** Arguments for 'modules' request. */
export declare interface ModulesArguments {
...
export declare interface ModulesResponse extends Response {
  body: {
...
*/
export declare interface LoadedSourcesRequest extends Request {
  // command: 'loadedSources';
  arguments?: LoadedSourcesArguments;
}

/** Arguments for 'loadedSources' request. */
export declare interface LoadedSourcesArguments {}

/** Response to 'loadedSources' request. */
export declare interface LoadedSourcesResponse extends Response {
  body: {
...
*/
export declare interface EvaluateRequest extends Request {
  // command: 'evaluate';
  arguments: EvaluateArguments;
}

/** Arguments for 'evaluate' request. */
export declare interface EvaluateArguments {
...
export declare interface EvaluateResponse extends Response {
  body: {
...
*/
export declare interface SetExpressionRequest extends Request {
  // command: 'setExpression';
  arguments: SetExpressionArguments;
}

/** Arguments for 'setExpression' request. */
export declare interface SetExpressionArguments {
...
export declare interface SetExpressionResponse extends Response {
  body: {
...
/**
  ...
  may only be called if the 'supportsStepInTargetsRequest' capability exists and
  is true.
*/
export declare interface StepInTargetsRequest extends Request {
  // command: 'stepInTargets';
  arguments: StepInTargetsArguments;
}

/** Arguments for 'stepInTargets' request. */
export declare interface StepInTargetsArguments {
  /** The stack frame for which to retrieve the possible stepIn targets. */
  frameId: number;
}

/** Response to 'stepInTargets' request. */
export declare interface StepInTargetsResponse extends Response {
  body: {
...
/**
  ...
  exists and is true.
*/
export declare interface GotoTargetsRequest extends Request {
  // command: 'gotoTargets';
  arguments: GotoTargetsArguments;
}

/** Arguments for 'gotoTargets' request. */
export declare interface GotoTargetsArguments {
...
export declare interface GotoTargetsResponse extends Response {
  body: {
...
*/
export declare interface CompletionsRequest extends Request {
  // command: 'completions';
  arguments: CompletionsArguments;
}

/** Arguments for 'completions' request. */
export declare interface CompletionsArguments {
  /**
...
export declare interface CompletionsResponse extends Response {
  body: {
...
*/
export declare interface ExceptionInfoRequest extends Request {
  // command: 'exceptionInfo';
  arguments: ExceptionInfoArguments;
}

/** Arguments for 'exceptionInfo' request. */
export declare interface ExceptionInfoArguments {
  /** Thread for which exception information should be retrieved. */
  threadId: number;
}

/** Response to 'exceptionInfo' request. */
export declare interface ExceptionInfoResponse extends Response {
  body: {
...
*/
export declare interface ReadMemoryRequest extends Request {
  // command: 'readMemory';
  arguments: ReadMemoryArguments;
}

/** Arguments for 'readMemory' request. */
export declare interface ReadMemoryArguments {
...
export declare interface ReadMemoryResponse extends Response {
  body?: {
    /**
       The address of the first byte of data returned. Treated as a hex value
       if prefixed with '0x', or as a decimal value otherwise.
     */
    address: string;
    /**
       The number of unreadable bytes encountered after the last successfully
       read byte. This can be used to determine the number of bytes that must be
...
*/
export declare interface DisassembleRequest extends Request {
  // command: 'disassemble';
  arguments: DisassembleArguments;
}

/** Arguments for 'disassemble' request. */
export declare interface DisassembleArguments {
  /**
...
export declare interface DisassembleResponse extends Response {
  body?: {
 ...
 */
export declare interface ExceptionBreakpointsFilter {
  /**
...
export declare interface Message {
  ...
  /**
    ...
    '{name}'. If variable name starts with an underscore character, the variable
...
/**
  ...
  the ModulesView, how to format it, and what the column's label should be. It
...
/**
  ...
  the modules view.
*/
export declare interface ModulesViewDescriptor {
...
export declare interface Source {
   ...
   * through the SourceRequest (even if a path is specified). A sourceReference
   * is only valid for a session, so it must not be used to persist a source.
   * The value should be less than or equal to 2147483647 (2^31 - 1).
   */
  sourceReference?: number;
  /**
...
export declare interface Scope {
  ...
  /**
    ...
    attribute is missing, the scope is shown with a generic UI. Values:
    'arguments': Scope contains method arguments.
    'locals': Scope contains local variables.
    'registers': Scope contains registers. Only a single 'registers' scope
    should be returned from a 'scopes' request. etc.
  */
...
/**
  ...
  Optionally a variable can have a 'type' that is shown if space permits or when
  hovering over the variable's name. An optional 'kind' is used to render
  additional properties of the variable, e.g. different icons can be used to
  indicate that a variable is public or private. If the value is structured (has
 ...
 */
export declare interface VariablePresentationHint {
  /**
    The kind of variable. Before introducing additional values, try to use the
    listed values. Values: 'property': Indicates that the object is a property.
    ...
    index range for large arrays. 'dataBreakpoint': Indicates that a data
    breakpoint is registered for the object. etc.
  */
  kind?: string;
  /**
    Set of attributes represented as an array of strings. Before introducing
    additional values, try to use the listed values. Values: 'static': Indicates
    that the object is static. 'constant': Indicates that the object is a
    constant. 'readOnly': Indicates that the object is read only. 'rawString':
    Indicates that the object is a raw string. 'hasObjectId': Indicates that the
    object can have an Object ID created for it. 'canHaveObjectId': Indicates
    that the object has an Object ID associated with it. 'hasSideEffects':
    Indicates that the evaluation had side effects. etc.
  */
  attributes?: string[];
  /**
    Visibility of variable. Before introducing additional values, try to use
    the listed values. Values: 'public', 'private', 'protected', 'internal',
    'final', etc.
  */
  visibility?: string;
}
 ...
 */
export declare interface SourceBreakpoint {
...
export declare interface FunctionBreakpoint {
...
export declare interface DataBreakpoint {
  /**
...
export declare interface Breakpoint {
  ...
  verified: boolean;
  /**
   * An optional message about the state of the breakpoint. This is shown to
   * the user and can be used to explain why a breakpoint could not be verified.
   */
  message?: string;
  ...
  endLine?: number;
  /**
   * An optional end column of the actual range covered by the breakpoint. If
   * no end line is given, then the end column is assumed to be in the start
   * line.
   */
  endColumn?: number;
}
 ...
 */
export declare interface StepInTarget {
...
/**
  ...
  'gotoTargets' request.
*/
export declare interface GotoTarget {
...
export declare interface CompletionItem {
  ...
  */
  ...
  /**
    ...
    completion text. If missing the value 0 is assumed which results in the
  ...
  */
  ...
  /**
    ...
    inserted (or replaced). The selection can not extend beyond the bounds of
    the completion text. If omitted the length is assumed to be 0.
  */
 ...
 */
export type CompletionItemType = 'method'|'function'|'constructor'|'field'|
    'variable'|'class'|'interface'|'module'|'property'|'unit'|'value'|'enum'|
...
export declare interface Checksum {
...
export declare interface StackFrameFormat extends ValueFormat {
...
export declare interface ExceptionOptions {
   ...
   * is missing, the whole tree is selected. By convention the first segment of
   * the path is a category that is used to group exceptions in the UI.
   */
 ...
 */
export declare interface ExceptionPathSegment {
  /**
...
export declare interface ExceptionDetails {
...
export declare interface DisassembledInstruction {
  /**
   ...
   * always be set (if available) on the first instruction returned, but can be
   * omitted afterwards if this instruction maps to the same source file as the
...
// tslint:enable:comments-documentation
